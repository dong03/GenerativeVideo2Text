...
def _load_video_from_path_decord(video_path, height=None, width=None, start_time=None, end_time=None, fps=-1):
    num_frm = 4
    try:
...
def predict(tfile):
    ...
    ress = tokenizer.decode(result['predictions'][0].tolist(),skip_special_tokens=True)
    return ress
