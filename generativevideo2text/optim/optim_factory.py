    ...
    optimizer_grouped_parameters = [
        {
            "params": [p for n, p in model.named_parameters() if
                       ((not any(nd in n for nd in no_decay)) and ("image_encoder" not in n))],
            "weight_decay": args.weight_decay,
            "lr": args.lr1
        },
        {
            "params": [p for n, p in model.named_parameters() if
                       ((any(nd in n for nd in no_decay)) and ("image_encoder" not in n))],
            "weight_decay": 0.0,
            "lr": args.lr1
        },
        {
            "params": [p for n, p in model.image_encoder.named_parameters() if
                       ((not any(nd in n for nd in no_decay)) and ("image_encoder" not in n))],
            "weight_decay": args.weight_decay,
            "lr": args.lr2
        },
